...
For a step-by-step guide focused on deploying EchoBot or custom calling bot code to a Windows VM with a public HTTPS calling endpoint, see [README-WINDOWS-VM-DEPLOYMENT.md](README-WINDOWS-VM-DEPLOYMENT.md).
