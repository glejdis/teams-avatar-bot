...
namespace EchoBot.Authentication
{
    ...
    public class AuthenticationProvider : ObjectRoot, IRequestAuthenticationProvider
    {
        ...
        /// <summary>
        /// The tenant ID for SingleTenant apps.
        /// </summary>
        ...
        public AuthenticationProvider(string appName, string appId, string appSecret, IGraphLogger logger, string tenantId = null)
        ...
        public async Task AuthenticateOutboundRequestAsync(HttpRequestMessage request, string tenant)
        {
            ...
            // If no tenant was specified, we craft the token link using the configured tenant.
            // https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-v2-protocols#endpoints
            tenant = string.IsNullOrWhiteSpace(tenant) ? this.tenantId ?? "common" : tenant;
